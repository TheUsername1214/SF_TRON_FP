...
if __name__ == '__main__':
    ...
    start_controller = robot_ip == "10.192.1.200"

    # Create and run the controller
    controller = controllers.SolefootController_Camera(f'{os.path.dirname(os.path.abspath(__file__))}/controllers/model', robot, robot_type, rl_type, start_controller)
    controller.run()
